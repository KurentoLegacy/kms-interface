...
The kms-interface project contains the Thrift interfaces between the Kurento Media Server native and java components.
...
[GitHub Repository]: https://github.com/kurento/kms-interface
