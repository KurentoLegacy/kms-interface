...
const i32 CONNECT_ERROR = 40004;
const i32 UNSUPPORTED_MEDIA_TYPE = 40005;
const i32 NOT_IMPLEMENTED = 40006;
...
const i32 MEDIA_OBJECT_METHOD_NOT_FOUND = 40105;
const i32 MEDIA_OBJECT_EVENT_NOT_SUPPORTED = 40106;
const i32 MEDIA_OBJECT_ILLEGAL_PARAM_ERROR = 40107;
const i32 MEDIA_OBJECT_NOT_AVAILAIBLE = 40108;
