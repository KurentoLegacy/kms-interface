...
service MediaSessionService extends mediaObject.MediaObjectService {
	...
	mixer.Mixer createMixer(1: MediaSession mediaSessionId, 2: list<mixer.MixerConfig> config) throws (1: common.MediaServerException mse, 2: MediaSessionNotFoundException msnfe);
	void deleteMixer(1: MediaSession mediaSessionId, 2: mixer.Mixer mixer) throws (1: common.MediaServerException mse, 2: MediaSessionNotFoundException msnfe, 3: mixer.MixerNotFoundException mnfe);
	list<mixer.Mixer> getMixers(1: MediaSession mediaSessionId) throws (1: common.MediaServerException mse, 2: MediaSessionNotFoundException msnfe);
}
